...
Total logged training runs: `294`.
...
| --- | --- | ---: | ---: | --- | --- | --- | --- | --- | ---: | --- | ---: | ---: |
| `pilot-cifar100-vit-lora-ef-lam1.json` | EF-EWC | 0 | 1 | cifar100 | vit_tiny_patch16_224 | lora | 3x5 | task_aware | 1 | train=20, test=10 | 0.3933 | 0.07 |
| `pilot-cifar100-vit-lora-ef-lam10.json` | EF-EWC | 0 | 10 | cifar100 | vit_tiny_patch16_224 | lora | 3x5 | task_aware | 1 | train=20, test=10 | 0.3733 | 0.07 |
| `pilot-cifar100-vit-lora-ef-lam30.json` | EF-EWC | 0 | 30 | cifar100 | vit_tiny_patch16_224 | lora | 3x5 | task_aware | 1 | train=20, test=10 | 0.38 | 0.07 |
| `pilot-cifar100-vit-lora-ef.json` | EF-EWC | 0 | 100 | cifar100 | vit_tiny_patch16_224 | lora | 3x5 | task_aware | 1 | train=20, test=10 | 0.36 | 0.04 |
| `pilot-cifar100-vit-lora-iewc-fromp.json` | IEWC-FROMP | 0 | 100 | cifar100 | vit_tiny_patch16_224 | lora | 3x5 | task_aware | 1 | train=20, test=10 | 0.3467 | 0.04 |
| `pilot-cifar100-vit-lora-iewc-gss.json` | IEWC-GSS | 0 | 100 | cifar100 | vit_tiny_patch16_224 | lora | 3x5 | task_aware | 1 | train=20, test=10 | 0.3533 | 0.04 |
| `pilot-cifar100-vit-lora-iewc-lam1.json` | IEWC | 0 | 1 | cifar100 | vit_tiny_patch16_224 | lora | 3x5 | task_aware | 1 | train=20, test=10 | 0.3933 | 0.07 |
| `pilot-cifar100-vit-lora-iewc-lam10.json` | IEWC | 0 | 10 | cifar100 | vit_tiny_patch16_224 | lora | 3x5 | task_aware | 1 | train=20, test=10 | 0.3867 | 0.06 |
| `pilot-cifar100-vit-lora-iewc-lam30.json` | IEWC | 0 | 30 | cifar100 | vit_tiny_patch16_224 | lora | 3x5 | task_aware | 1 | train=20, test=10 | 0.38 | 0.06 |
| `pilot-cifar100-vit-lora-iewc.json` | IEWC | 0 | 100 | cifar100 | vit_tiny_patch16_224 | lora | 3x5 | task_aware | 1 | train=20, test=10 | 0.3533 | 0.04 |
| `pilot-cifar100-vit-lora-sequential.json` | Sequential | 0 | - | cifar100 | vit_tiny_patch16_224 | lora | 3x5 | task_aware | 1 | train=20, test=10 | 0.3933 | 0.07 |
| `pilot-cifar100-vit-scratch-ef-stronger.json` | EF-EWC | 0 | 100 | cifar100 | vit_tiny_patch16_224 | full | 3x5 | task_aware | 8 | train=100, test=20 | 0.13 | 0.415 |
| `pilot-cifar100-vit-scratch-iewc-stronger.json` | IEWC | 0 | 100 | cifar100 | vit_tiny_patch16_224 | full | 3x5 | task_aware | 8 | train=100, test=20 | 0.1333 | 0.425 |
| `pilot-cifar100-vit-scratch-sequential-stronger.json` | Sequential | 0 | - | cifar100 | vit_tiny_patch16_224 | full | 3x5 | task_aware | 8 | train=100, test=20 | 0.11 | 0.405 |
| `pilot-cifar100-vit-scratch-sequential.json` | Sequential | 0 | - | cifar100 | vit_tiny_patch16_224 | full | 3x5 | task_aware | 2 | train=20, test=10 | 0.0933 | 0.22 |
| `smoke-vision-lora-gss.json` | IEWC-GSS | 0 | 100 | cifar100 | vit_tiny_patch16_224 | lora | 2x2 | task_aware | 1 | train=2, test=2 | 0.125 | 0 |
| `smoke-vision-sequential.json` | Sequential | 0 | - | cifar100 | vit_tiny_patch16_224 | full | 2x2 | task_aware | 1 | train=2, test=2 | 0.25 | 0 |
...
| `pilot-imagenet-r-vit-lora-sequential-3x10-10shot-e1.json` | Sequential | 0 | - | imagenet_r | vit_tiny_patch16_224 | lora | 3x10 | task_aware | 1 | train=10, test=5 | 0.2333 | 0.04 |
...
| `vision-vitb-imagenetr-10x20-full-e2-classinc-ef-seed0-lam111p111.json` | EF-EWC | 0 | 111.111111 | imagenet_r | vit_base_patch16_224 | lora | 10x20 | class_incremental | 2 | train=0, test=0 | 0.5692 | 0.3961 |
...
| `vision-vitb-imagenetr-10x20-full-e2-classinc-ef-seed0-lam333p333.json` | EF-EWC | 0 | 333.333333 | imagenet_r | vit_base_patch16_224 | lora | 10x20 | class_incremental | 2 | train=0, test=0 | 0.5987 | 0.3563 |
...
| `vision-vitb-imagenetr-10x20-full-e2-classinc-ef-seed1-lam333p333.json` | EF-EWC | 1 | 333.333333 | imagenet_r | vit_base_patch16_224 | lora | 10x20 | class_incremental | 2 | train=0, test=0 | 0.6315 | 0.3234 |
| `vision-vitb-imagenetr-10x20-full-e2-classinc-ef-seed2-lam333p333.json` | EF-EWC | 2 | 333.333333 | imagenet_r | vit_base_patch16_224 | lora | 10x20 | class_incremental | 2 | train=0, test=0 | 0.5642 | 0.3987 |
...
| `vision-vitb-imagenetr-10x20-full-e2-classinc-iewc-seed0-lam11p1111.json` | IEWC | 0 | 11.111111 | imagenet_r | vit_base_patch16_224 | lora | 10x20 | class_incremental | 2 | train=0, test=0 | 0.5022 | 0.4726 |
...
| `vision-vitb-imagenetr-10x20-full-e2-classinc-iewc-seed0-lam33p3333.json` | IEWC | 0 | 33.333333 | imagenet_r | vit_base_patch16_224 | lora | 10x20 | class_incremental | 2 | train=0, test=0 | 0.6146 | 0.3435 |
| `vision-vitb-imagenetr-10x20-full-e2-classinc-iewc-seed1-lam33p3333.json` | IEWC | 1 | 33.333333 | imagenet_r | vit_base_patch16_224 | lora | 10x20 | class_incremental | 2 | train=0, test=0 | 0.6114 | 0.3472 |
| `vision-vitb-imagenetr-10x20-full-e2-classinc-iewc-seed2-lam33p3333.json` | IEWC | 2 | 33.333333 | imagenet_r | vit_base_patch16_224 | lora | 10x20 | class_incremental | 2 | train=0, test=0 | 0.5621 | 0.4044 |
...
| `vision-vitb-imagenetr-10x20-full-e2-classinc-iewc_fromp-seed0-lam11p1111.json` | IEWC-FROMP | 0 | 11.111111 | imagenet_r | vit_base_patch16_224 | lora | 10x20 | class_incremental | 2 | train=0, test=0 | 0.6304 | 0.3238 |
...
| `vision-vitb-imagenetr-10x20-full-e2-classinc-iewc_fromp-seed0-lam33p3333.json` | IEWC-FROMP | 0 | 33.333333 | imagenet_r | vit_base_patch16_224 | lora | 10x20 | class_incremental | 2 | train=0, test=0 | 0.6363 | 0.3066 |
| `vision-vitb-imagenetr-10x20-full-e2-classinc-iewc_fromp-seed1-lam33p3333.json` | IEWC-FROMP | 1 | 33.333333 | imagenet_r | vit_base_patch16_224 | lora | 10x20 | class_incremental | 2 | train=0, test=0 | 0.653 | 0.2899 |
| `vision-vitb-imagenetr-10x20-full-e2-classinc-iewc_fromp-seed2-lam33p3333.json` | IEWC-FROMP | 2 | 33.333333 | imagenet_r | vit_base_patch16_224 | lora | 10x20 | class_incremental | 2 | train=0, test=0 | 0.6201 | 0.3238 |
...
| `vision-vitb-imagenetr-10x20-full-e2-classinc-iewc_gss-seed0-lam11p1111.json` | IEWC-GSS | 0 | 11.111111 | imagenet_r | vit_base_patch16_224 | lora | 10x20 | class_incremental | 2 | train=0, test=0 | 0.6305 | 0.322 |
...
| `vision-vitb-imagenetr-10x20-full-e2-classinc-iewc_gss-seed0-lam33p3333.json` | IEWC-GSS | 0 | 33.333333 | imagenet_r | vit_base_patch16_224 | lora | 10x20 | class_incremental | 2 | train=0, test=0 | 0.5826 | 0.363 |
| `vision-vitb-imagenetr-10x20-full-e2-classinc-iewc_gss-seed0-lam3p7037.json` | IEWC-GSS | 0 | 3.703704 | imagenet_r | vit_base_patch16_224 | lora | 10x20 | class_incremental | 2 | train=0, test=0 | 0.5938 | 0.3642 |
| `vision-vitb-imagenetr-10x20-full-e2-classinc-iewc_gss-seed1-lam11p1111.json` | IEWC-GSS | 1 | 11.111111 | imagenet_r | vit_base_patch16_224 | lora | 10x20 | class_incremental | 2 | train=0, test=0 | 0.6481 | 0.3045 |
| `vision-vitb-imagenetr-10x20-full-e2-classinc-iewc_gss-seed2-lam11p1111.json` | IEWC-GSS | 2 | 11.111111 | imagenet_r | vit_base_patch16_224 | lora | 10x20 | class_incremental | 2 | train=0, test=0 | 0.5964 | 0.3589 |
...
| --- | --- | ---: | ---: | --- | --- | --- | --- | --- | ---: | --- | ---: | ---: |
| `pilot-m4-forecast-ef.json` | EF-EWC | 0 | 10 | m4 | hourly,weekly,daily | TransformerEncoder d=64, L=2, H=4, ff=128 | 48->12 | train=4, eval=- | 3 | context | 1.9959 | 0.7133 |
| `pilot-m4-forecast-iewc.json` | IEWC | 0 | 10 | m4 | hourly,weekly,daily | TransformerEncoder d=64, L=2, H=4, ff=128 | 48->12 | train=4, eval=- | 3 | context | 2.0085 | 0.7272 |
| `pilot-m4-forecast-sequential.json` | Sequential | 0 | - | m4 | hourly,weekly,daily | TransformerEncoder d=64, L=2, H=4, ff=128 | 48->12 | train=4, eval=- | 3 | context | 2.0826 | 0.8395 |
| `pilot-m4-transformer-ef-l1-4freq-e4.json` | EF-EWC | 0 | 1 | m4 | hourly,weekly,daily,monthly | TransformerEncoder d=64, L=2, H=4, ff=128 | 48->12 | train=4, eval=- | 4 | context | 2.9904 | 1.7264 |
| `pilot-m4-transformer-ef-l10-4freq-e4.json` | EF-EWC | 0 | 10 | m4 | hourly,weekly,daily,monthly | TransformerEncoder d=64, L=2, H=4, ff=128 | 48->12 | train=4, eval=- | 4 | context | 3.0066 | 1.7422 |
| `pilot-m4-transformer-ef-l100-4freq-e4.json` | EF-EWC | 0 | 100 | m4 | hourly,weekly,daily,monthly | TransformerEncoder d=64, L=2, H=4, ff=128 | 48->12 | train=4, eval=- | 4 | context | 3.163 | 1.9097 |
| `pilot-m4-transformer-ef-l3-4freq-e4.json` | EF-EWC | 0 | 3 | m4 | hourly,weekly,daily,monthly | TransformerEncoder d=64, L=2, H=4, ff=128 | 48->12 | train=4, eval=- | 4 | context | 2.992 | 1.7274 |
| `pilot-m4-transformer-ef-l30-4freq-e4.json` | EF-EWC | 0 | 30 | m4 | hourly,weekly,daily,monthly | TransformerEncoder d=64, L=2, H=4, ff=128 | 48->12 | train=4, eval=- | 4 | context | 3.0561 | 1.7959 |
| `pilot-m4-transformer-iewc-l1-4freq-e4.json` | IEWC | 0 | 1 | m4 | hourly,weekly,daily,monthly | TransformerEncoder d=64, L=2, H=4, ff=128 | 48->12 | train=4, eval=- | 4 | context | 2.9907 | 1.7268 |
| `pilot-m4-transformer-iewc-l10-4freq-e4.json` | IEWC | 0 | 10 | m4 | hourly,weekly,daily,monthly | TransformerEncoder d=64, L=2, H=4, ff=128 | 48->12 | train=4, eval=- | 4 | context | 3.0034 | 1.7358 |
| `pilot-m4-transformer-iewc-l100-4freq-e4.json` | IEWC | 0 | 100 | m4 | hourly,weekly,daily,monthly | TransformerEncoder d=64, L=2, H=4, ff=128 | 48->12 | train=4, eval=- | 4 | context | 3.1436 | 1.8704 |
| `pilot-m4-transformer-iewc-l3-4freq-e4.json` | IEWC | 0 | 3 | m4 | hourly,weekly,daily,monthly | TransformerEncoder d=64, L=2, H=4, ff=128 | 48->12 | train=4, eval=- | 4 | context | 2.9925 | 1.7279 |
| `pilot-m4-transformer-iewc-l30-4freq-e4.json` | IEWC | 0 | 30 | m4 | hourly,weekly,daily,monthly | TransformerEncoder d=64, L=2, H=4, ff=128 | 48->12 | train=4, eval=- | 4 | context | 3.0505 | 1.781 |
| `pilot-m4-transformer-sequential-4freq-e4.json` | Sequential | 0 | - | m4 | hourly,weekly,daily,monthly | TransformerEncoder d=64, L=2, H=4, ff=128 | 48->12 | train=4, eval=- | 4 | context | 2.9753 | 1.7058 |
| `smoke-forecast-iewc.json` | IEWC | 0 | 10 | m4 | hourly,weekly | TransformerEncoder d=16, L=1, H=2, ff=32 | 24->6 | train=1, eval=- | 1 | context | 4.5911 | 0 |
| `smoke-forecast-sequential.json` | Sequential | 0 | - | m4 | hourly,weekly | TransformerEncoder d=16, L=1, H=2, ff=32 | 24->6 | train=1, eval=- | 1 | context | 4.5911 | 0 |
...
| `forecasting-ett-4task-transformer-d128-e10-lr3e4-series-ef-seed0-lam0p00037037.json` | EF-EWC | 0 | 0.0003704 | ett | ETTh1,ETTh2,ETTm1,ETTm2 | TransformerEncoder d=128, L=3, H=4, ff=256 | 96->24 | train=512, eval=128 | 10 | series | 0.1952 | 0.0239 |
| `forecasting-ett-4task-transformer-d128-e10-lr3e4-series-ef-seed0-lam0p00111111.json` | EF-EWC | 0 | 0.001111 | ett | ETTh1,ETTh2,ETTm1,ETTm2 | TransformerEncoder d=128, L=3, H=4, ff=256 | 96->24 | train=512, eval=128 | 10 | series | 0.1952 | 0.0239 |
| `forecasting-ett-4task-transformer-d128-e10-lr3e4-series-ef-seed0-lam0p00333333.json` | EF-EWC | 0 | 0.003333 | ett | ETTh1,ETTh2,ETTm1,ETTm2 | TransformerEncoder d=128, L=3, H=4, ff=256 | 96->24 | train=512, eval=128 | 10 | series | 0.1952 | 0.0239 |
...
| `forecasting-ett-4task-transformer-d128-e10-lr3e4-series-ef-seed1-lam0p00037037.json` | EF-EWC | 1 | 0.0003704 | ett | ETTh1,ETTh2,ETTm1,ETTm2 | TransformerEncoder d=128, L=3, H=4, ff=256 | 96->24 | train=512, eval=128 | 10 | series | 0.1953 | 0.0253 |
| `forecasting-ett-4task-transformer-d128-e10-lr3e4-series-ef-seed2-lam0p00037037.json` | EF-EWC | 2 | 0.0003704 | ett | ETTh1,ETTh2,ETTm1,ETTm2 | TransformerEncoder d=128, L=3, H=4, ff=256 | 96->24 | train=512, eval=128 | 10 | series | 0.205 | 0.0312 |
...
| `nlp-t5base-lora-glue-sst2-mrpc-qqp-2048-e3-highlambda-ewc_dr-seed0-lam11p1111.json` | EWC-DR | 0 | 11.111111 | t5-base | lora | sst2->mrpc->qqp | train=2048, eval=1024 | 3 | 8 | 0.6771 | 0.1706 |
...
| `nlp-t5base-lora-glue-sst2-mrpc-qqp-2048-e3-highlambda-ewc_dr-seed0-lam33p3333.json` | EWC-DR | 0 | 33.333333 | t5-base | lora | sst2->mrpc->qqp | train=2048, eval=1024 | 3 | 8 | 0.7184 | 0.096 |
...
| `nlp-t5base-lora-glue-sst2-mrpc-qqp-2048-e3-highlambda-ewc_dr-seed1-lam33p3333.json` | EWC-DR | 1 | 33.333333 | t5-base | lora | sst2->mrpc->qqp | train=2048, eval=1024 | 3 | 8 | 0.7339 | 0.0814 |
| `nlp-t5base-lora-glue-sst2-mrpc-qqp-2048-e3-highlambda-ewc_dr-seed2-lam33p3333.json` | EWC-DR | 2 | 33.333333 | t5-base | lora | sst2->mrpc->qqp | train=2048, eval=1024 | 3 | 8 | 0.711 | 0.1071 |
